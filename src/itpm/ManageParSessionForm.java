 ...
 * @author Dell
 */
public class ManageParSessionForm extends javax.swing.JFrame {

    psession std1 =  new psession();
    public ManageParSessionForm() {
        initComponents();
    }
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        std1.insertUpdateDeleteStudent('u', SID, acyear, semester,  groupid, sgroupid, genid, groupid1,sgroupid1 );
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        if(id.getText().equals(""))
        {
            ...
            int SID = Integer.valueOf(id.getText());
            std1.insertUpdateDeleteStudent('d', SID, null, null, null, null, null,null,null);
    ...
    private void jTextField_Val_FindKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_Val_FindKeyReleased
        ...
        std1.fillStudentJtable(jTable1, jTextField_Val_Find.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageParSessionForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageParSessionForm().setVisible(true);
            }
        });
    }
