...
public class manage_workingdayshours extends javax.swing.JFrame {


    addworkingdayshours adw =  new addworkingdayshours();
    
    public manage_workingdayshours() {
        initComponents();
        
        adw.fillWorkingdayshoursJtable(jTable1,"");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NUMBER OF WORKING DAYS", "WORKING DAYS", "WORKING TIME[Per Day]", "ACTION"
            }
        ) {
...
public void fillStudentJtable(JTable table, String valueToSearch){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manage_workingdayshours.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new manage_workingdayshours().setVisible(true);
            }
        });
    }
